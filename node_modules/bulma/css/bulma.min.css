...
.select.is-loading:after {
    ...
    border-bottom: 2px solid var(--bulma-loading-color);
    border-left: 2px solid var(--bulma-loading-color);
    border-radius: var(--bulma-radius-rounded);
...
.navbar-item.is-tab.is-active {
    ...
    border-bottom: var(--bulma-navbar-tab-active-border-bottom-width) var(--bulma-navbar-tab-active-border-bottom-style) var(--bulma-navbar-tab-active-border-bottom-color);
...
@media screen and (min-width:1024px) {
    ...
    .navbar-item.has-dropdown-up .navbar-dropdown {
        border-bottom: var(--bulma-navbar-dropdown-border-width) var(--bulma-navbar-dropdown-border-style) var(--bulma-navbar-dropdown-border-color);
...
.panel-tabs a {
    border-bottom: var(--bulma-panel-tab-border-bottom-width) var(--bulma-panel-tab-border-bottom-style) var(--bulma-panel-tab-border-bottom-color);
    margin-bottom: -1px;
    padding: .75em
}
...
.media .media {
    border-top: var(--bulma-media-border-size) solid var(--bulma-media-border-color);
    display: flex;
